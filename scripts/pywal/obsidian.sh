...
theme () {
    ...
    echo "  --background-primary-alt: $(head -n 1 ~/.cache/wal/colors | tail -1);" >> "$theme_dir/theme.css"
    ...
    echo "  --text-accent-hover: $(head -n 4 ~/.cache/wal/colors | tail -1);" >> "$theme_dir/theme.css"
    echo "  --background-modifier-border: $(head -n 2 ~/.cache/wal/colors | tail -1);" >> "$theme_dir/theme.css"
    echo "  --text-highlight-bg: $(head -n 2 ~/.cache/wal/colors | tail -1);" >> "$theme_dir/theme.css"
